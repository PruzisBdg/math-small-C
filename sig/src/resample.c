...
/* ---------------------------- DownSampleS16_Run -----------------------------------------
   ...
   DownSampleS16 is non-normalising; samples from 'in' to 'out' are scaled by 'inRate'/'outRate'.

   DownSampleS16 does not leak; when 'r' is flushed the sum of all 'out's will equal
   sum of all 'in's.
*/
