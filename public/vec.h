...
#include "math_common.h"      /* common definitions */
...
#define Vec_MaxRows MAX_U8
#define _Vec_LAST_ROW  MAX_U8
   ...
   #define Vec_MaxCols MAX_U16
   #define _Vec_LAST_COL  MAX_U16
   typedef U32 T_RowByCol;
#else
   typedef U8 T_VecCols;
   typedef U8 T_VecRowOrCol;
   #define Vec_MaxCols MAX_U8
   #define _Vec_LAST_COL  MAX_U8
