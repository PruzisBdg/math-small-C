...
// For the text below, select float as the type.
typedef float T_Integral;

PUBLIC T_Integral SimpsonFloat( T_Integral(*f)(T_Integral), T_Integral start, T_Integral intvl, S16 steps)
{
	T_Integral x,
              sum;
	S16        i;
